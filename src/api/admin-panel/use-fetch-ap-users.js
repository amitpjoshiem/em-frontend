...
export const useFetchAdminPanelUsers = (page) => {
  ...
  const userStatusFilter = computed(() => store.state.adminPanelUsers.filterStatusAdminPanel)
  ...
  const reactiveUserStatusFilter = ref(userStatusFilter)
