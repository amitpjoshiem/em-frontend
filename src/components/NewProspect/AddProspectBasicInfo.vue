    ...
    <el-form ref="form" :model="ruleForm" :rules="rules" label-position="top" :disabled="isDisabledForm">
      ...
      <div class="border-b px-8 pb-5">
        ...
        <div class="flex">
          <el-form-item label="Account name" prop="name" class="w-8/12 pr-4">
            <el-input v-model="ruleForm.name" placeholder="Enter account name" @blur="handleChange" />
          </el-form-item>
        ...
        <div class="flex mt-6">
          <el-form-item label="E-mail" prop="email" class="w-6/12">
            <el-input v-model.email="ruleForm.email" placeholder="Enter prospect’s e-mail" @blur="handleChange" />
          </el-form-item>
      ...
      <div v-if="ruleForm.married" class="px-8 border-b py-5">
        ...
        <div class="flex">
          ...
          <el-form-item label="Last name" prop="spouse.last_name" class="w-5/12 pr-4">
            <el-input v-model="ruleForm.spouse.last_name" placeholder="Enter spouse’s last name" @blur="handleChange" />
          </el-form-item>
        ...
        <div class="flex my-5">
          <el-form-item label="E-mail" prop="spouse.email" class="w-5/12 pr-4">
            <el-input v-model.email="ruleForm.spouse.email" placeholder="Enter spouse’s e-mail" @blur="handleChange" />
          </el-form-item>
        ...
        <el-form-item v-for="(eh, index) in ruleForm.employment_history" :key="index" class="mb-2">
          ...
          <template v-if="!!ruleForm.employment_history[index].company_name.trim().length">
            <el-form-item :prop="'employment_history.' + index + '.occupation'" label="Occupation" class="w-4/12 px-2">
              <el-input v-model="eh.occupation" placeholder="Company occupation" @blur="handleChange" />
            </el-form-item>
            <el-form-item
              ...
              class="w-2/12"
            >
              <el-input v-model="eh.years" placeholder="00" inputmode="numeric" type="number" @blur="handleChange" />
            </el-form-item>
          </template>
      ...
      <div class="px-8 my-5">
        ...
        <el-form-item
          ...
          class="mb-4"
        >
          <el-input v-model="ruleForm.other.questions" type="textarea" @blur="handleChange" />
        </el-form-item>
        <el-form-item label="Goal for retiretment" prop="retirement" class="mb-4">
          <el-input v-model="ruleForm.other.retirement" type="textarea" @blur="handleChange" />
        </el-form-item>
        <el-form-item label="Goal for retiretment money" prop="retirement_money" class="mb-4">
          <el-input v-model="ruleForm.other.retirement_money" type="textarea" @blur="handleChange" />
        </el-form-item>
