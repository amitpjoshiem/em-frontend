<template>
  <div class="bg-main-gray p-2.5 rounded-md mt-5 flex justify-center">
    <div class="flex items-center justify-between w-8/12">
      ...
      <div>
        <span class="text-xs text-main">Total Opportunities: </span>
        <span class="text-xs text-main font-medium">{{ currencyFormat(total) }}</span>
      </div>
      <div class="flex items-center justify-center h-4.5 rounded-md bg-main-green" :class="getPercentClass">
