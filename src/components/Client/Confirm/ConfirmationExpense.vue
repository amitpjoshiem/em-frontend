    ...
    <div>
      ...
      <el-card shadow="never" class="mb-5">
        ...
        <div class="md:flex mb-4">
          ...
          <div class="flex md:w-4/12">
            <ConfirmExpenseItem :item="data.food_transportation.vehicle_purchases_payments.essential" class="w-6/12" />
            <ConfirmExpenseItem
        ...
        <div class="md:flex mb-4">
          ...
          <div class="flex md:w-4/12">
            <ConfirmExpenseItem :item="data.food_transportation.auto_insurance_and_taxes.essential" class="w-6/12" />
            <ConfirmExpenseItem
        ...
        <div class="md:flex mb-4">
          ...
          <div class="flex md:w-4/12">
            ...
            <ConfirmExpenseItem :item="data.food_transportation.fuel_and_maintenance.discretionary" class="w-6/12" />
          </div>
        </div>
        <div class="md:flex mb-4">
          <div class="w-3/12" />
          ...
          <div class="flex md:w-4/12">
            ...
            <ConfirmExpenseItem :item="data.food_transportation.public_transportation.discretionary" class="w-6/12" />
          </div>
        </div>
      </el-card>
      ...
      <el-card shadow="never" class="mb-5">
        ...
        <div class="md:flex mb-4">
          ...
          <div class="flex md:w-4/12">
            <ConfirmExpenseItem :item="data.healthcare.copays_uncovered_medical_services.essential" class="w-6/12" />
            <ConfirmExpenseItem
...
import ConfirmExpenseItem from './ConfirmExpenseItem.vue'
export default {
