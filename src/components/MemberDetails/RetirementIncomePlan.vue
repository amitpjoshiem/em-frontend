<template>
  <div class="w-16/24 border border-color-grey box-border rounded-md p-5 bg-widget-bg">
    <div>
...
<script>
import RetirementIncomeChart from '@/components/MemberDetails/Chart/RetirementIncomeChart.vue'

export default {
  name: 'RetirementIncomePlan',
  components: {
